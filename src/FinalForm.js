...
function createForm<FormValues: FormValuesShape>(
  ...
  const api: FormApi<FormValues> = {
    ...
    registerField: (
      ...
      // get the index -- since the subscrition to field state could happen outside of this call
      // it makes sense that we use incremented index to keep track of this particular registration
